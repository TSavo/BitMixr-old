...
public class ReplayableBlockStore implements BlockStore{
    ...
    private final LinkedHashMap<Sha256Hash, StoredBlock> blockCache = new LinkedHashMap<Sha256Hash, StoredBlock>() {
    ...
    private final LinkedHashMap<Sha256Hash, StoredBlock> notFoundCache = new LinkedHashMap<Sha256Hash, StoredBlock>() {
    ...
    private static class Record {
        ...
        private final byte[] chainWork;     // 16 bytes
        private final byte[] blockHeader;   // 80 bytes
...
//                }
    ...
    private final ByteBuffer buf = ByteBuffer.allocateDirect(Record.SIZE);
